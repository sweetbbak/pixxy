...
// Moved moves everything by the delta vector2.
func (m Matrix) Moved(delta Vec2) Matrix {
...
func (m Matrix) ScaledXY(around Vec2, scale Vec2) Matrix {
...
func (m Matrix) Scaled(around Vec2, scale float64) Matrix {
	return m.ScaledXY(around, V(scale, scale))
}

// Rotated rotates everything around a given point by the given angle in radians.
func (m Matrix) Rotated(around Vec2, angle float64) Matrix {
...
func (m Matrix) RotatedDegrees(around Vec2, degrees float64) Matrix {
...
// Project applies all transformations added to the Matrix to a vector2 u and returns the result.
//
// Time complexity is O(1).
func (m Matrix) Project(u Vec2) Vec2 {
	return Vec2{m[0]*u.X + m[2]*u.Y + m[4], m[1]*u.X + m[3]*u.Y + m[5]}
}

// Unproject does the inverse operation to Project.
//
// Time complexity is O(1).
func (m Matrix) Unproject(u Vec2) Vec2 {
	det := m[0]*m[3] - m[2]*m[1]
	return Vec2{
