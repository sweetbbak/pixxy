...
func ColorToVec3(clr color.Color) Vec3 {
	r, g, b, _ := clr.RGBA()
	r, g, b = r>>8, g>>8, b>>8
...
func (v *Vec3) To16Bit() (r uint32, g uint32, b uint32, a uint32) {
...
func Vec3ToColor(v Vec3) color.Color {
	// r, g, b, a := v.To16Bit()

	linearize := func(f float64) uint8 {
		c := (f * MAX8)
		c = Clamp(c, 0.0, 255.0)
		c = math.Round(c)
		return uint8(c)
