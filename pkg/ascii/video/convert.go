...
import (
	...
	"pix/pkg/ascii"
	"pix/pkg/ascii/video/internal/parse"
)

func Convert(ctx context.Context, src, dst string, opts []ascii.Option, args ...string) error {
	...
	for img := range imgD {
		asciiImg, err := ascii.ConvertWithOpts(img, opts...)
		if err != nil {
			close(imgE)
			return err
		}
